...
const Postamat = (props) => {
    ...
    return (
        <>
            ...
            <div
                className={
                    "h-72 w-5/6 flex flex-col bg-white p-2 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-100%] overflow-y-scroll rounded"
                }
            >
                            ...
                            {data.map((postamat) => {
                                return (
                                    <Placemark
                                        ...
                                        defaultGeometry={[
                                            postamat.location.latitude,
                                            postamat.location.longitude
                                        ]}
                                    />
                                );
                            })}
            ...
            <form
                onSubmit={handleForm}
                className={`w-5/6 overflow-y-scroll shadow-[0_4px_6px_-1px_rgb(0,0,0,0.1),0_2px_4px_-2px_rgb(0,0,0,0.1)] p-2 bg-secondary text-white ${
                    isVisible ? "visible" : "invisible"
                } absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[200%] rounded`}
            >
                <h1 className={"text-2xl text-center"}>
                    Форма добавления Постамата
                </h1>
                <div className={"flex flex-wrap gap-2"}>
                    <div>
                        ...
                        <Input
                            type={"number"}
                            name={"externalId"}
                            contentValue={postamatData.externalId}
                    ...
                    <div>
                        ...
                        <Input
                            name={"district"}
                            contentValue={postamatData.location.district}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            name={"administrativeDistrict"}
                            contentValue={
                                postamatData.location.administrativeDistrict
                            }
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    ...
                    <div>
                        ...
                        <Input
                            name={"entrance"}
                            contentValue={postamatData.location.entrance}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            name={"address"}
                            contentValue={postamatData.location.address}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            type={"number"}
                            name={"latitude"}
                            contentValue={postamatData.location.latitude}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            type={"number"}
                            name={"longitude"}
                            contentValue={postamatData.location.longitude}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            type={"number"}
                            name={"size"}
                            contentValue={postamatData.size}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            name={"lastDateActivity"}
                            type={"date"}
                            contentValue={postamatData.lastDateActivity}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            type={"url"}
                            name={"videoLink"}
                            contentValue={postamatData.location.videoLink}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            name={"postamatInit"}
                            type={"date"}
                            contentValue={postamatData.location.postamatInit}
                            updateFunc={updateInput}
                            isRequired={true}
                        />
                    </div>
                ...
                <button
                    className={
                        "p-3 w-full bg-primary font-bold text-white my-2 rounded hover:bg-black transition duration-700 ease-in-out"
                    }
                >
                    Создать
                </button>
            ...
            {postamatCrop.length !== 0 && (
                <form
                    ...
                    className={`flex flex-wrap gap-2 w-1/2 h-fit  overflow-y-scroll shadow-[0_4px_6px_-1px_rgb(0,0,0,0.1),0_2px_4px_-2px_rgb(0,0,0,0.1)] p-2 bg-secondary text-white absolute left-[25%]   bottom-[50px]   rounded`}
                >
                    <div>
                        <label>Номер Постамата</label>
                        <Input
                            ...
                            type={"number"}
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.externalId}
                        />
                    </div>
                    <div>
                        <label>Размер</label>
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.location.district}
                        />
                    </div>
                    <div>
                        <label>Административный округ</label>
                        <Input
                            ...
                            updateFunc={handleUpdateInput}
                            contentValue={
                                ymapData?.location.administrativeDistrict
                            }
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.location.entrance}
                        />
                    </div>
                    <div>
                        <label>Адрес</label>
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.location.address}
                        />
                    </div>
                    <div>
                        <label>Последняя активность</label>
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.lastDateActivity}
                        />
                    </div>
                    <div>
                        ...
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.videoLink}
                        />
                    </div>
                    <div>
                        <label>Дата установки постамата</label>
                        <Input
                            ...
                            isRequired={true}
                            updateFunc={handleUpdateInput}
                            contentValue={ymapData?.postamatInit}
                        />
                    </div>
                    <button
                        className={
